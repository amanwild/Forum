...
<body>
    ...
    include "./services/set_profile_image.php";
    include "./services/remove_profile_image.php";
    ?>
    ...
    <section style="background-color: #eee;">
        <div class="container py-5">
            ...
            <div class="row">
                            ...
                            <div class="card-body text-center">
                                <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <label for="file-upload" class="custom-file-upload p-4">
                                        ...
                                        <img src="/forum/data/<?= $_SESSION['user_img_url'] ?>" alt="avatar"class="rounded-circle img-fluid" style="width: 150px;object-fit:cover;height:150px">
                ...
                <div class="col-lg-8">
                    <?php
                    include "./components/user_information_card.php" ?>
                </div>
            </div>
