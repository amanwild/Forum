<div class="modal fade" id="show_followings_Modal" tabindex="-1" role="dialog" aria-labelledby="show_followings_ModalLabel" aria-hidden="true">
      <div class="modal-dialog" style="max-width: 600px;" role="document">
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" id="show_followings_ModalLabel"> <span id="following_count_in_modal<?= $ac_owner_Id ?>"></span> Followings</h5>
